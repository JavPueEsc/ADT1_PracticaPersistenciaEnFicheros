...
public class Principal {
	...
	public static void main(String[] args) {
		...
		while (opcionUsuario != 'G') {
			...
			if (opcionUsuario == 'E') {
				...
				if (listaDeLaCompra.listaArticulos.isEmpty()) {
					...
					listaDeLaCompra.eliminarArticulo(listaDeLaCompra.listaArticulos.get(articuloEliminado).getDescripcion()); //.listaArticulos.remove(articuloEliminado);
					System.out.println("La lista de la compra ha quedado de la siguiente manera:");
					mostrarLista(listaDeLaCompra);
					System.out.println(" ");
					System.out.println("-------------------------------------------------------------------------");
		...
		if (opcionUsuario == 'G') {
			...
			System.out.println(
					"La lista de la compra '" + listaDeLaCompra.getNombreLista() + "' se ha guardado correctamente");
			System.exit(0);
		}
